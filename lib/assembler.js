...
function assembleNodeEx(node, insns, insnsList) {
    ...
    case N.SUPER_CALL:
        {
            ...
            makeInstruction(I.SUPER_CALL, {operand: node.arguments.length});
        }
        break;
    case N.NEW:
        {
            ...
            makeInstruction(I.NEW, {operand: node.arguments.length});
        }
        break;
    ...
    case N.ASSIGNMENT:
        ...
        case N.IDENTIFIER_REFERENCE:
            ...
            break;
        case N.PROPERTY_REF:
            assembleNode(node.left.object, insns);
            makeInstruction(I.PUSH, {operand: node.left.property});
            makeInstruction(I.SET_PROPERTY);
            break;
        case N.ARRAY_REF:
            assembleNode(node.left.object, insns);
            assembleNode(node.left.index, insns);
            makeInstruction(I.SET_PROPERTY);
            break;
        }
        break;
    ...
    case N.FOR_OF:
        {
            ...
            makeInstruction(I.GET_PROPERTY);
            makeInstruction(I.CALL, {operand: 0});

            // break/continue info
            const breakOffset = stmtInsns.length + 18; // to after POP_BREAKABLE
            const continueOffset = 0;
            makeInstruction(I.PUSH_BREAKABLE, {breakOffset, continueOffset});
            ...
            // 6. jump to 2.
            makeInstruction(I.POP_SCOPE);
            makeInstruction(I.JUMP, {offset: -stmtInsns.length - 15});
    ...
    case N.ARROW_FUNCTION: // TODO: bind this
        {
            makeFunction(node);
