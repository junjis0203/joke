...
function assembleNodeEx(node, insns, insnsList) {
    ...
    case N.ASSIGNMENT:
        ...
        case N.MEMBER:
            ...
            makeInstruction(I.MEMBER_ASSIGN);
            break;
        case N.ARRAY_REF:
            assembleNode(node.left.object, insns);
    ...
    case N.CLASS_DECLARATION:
        {
            ...
            makeInstruction(I.DEFINE, {operand1: node.name, operand2: 'const'});
            makeInstruction(I.PUSH, {operand: node.name});
            makeInstruction(I.INITIALIZE);
            ...
            for (const m of node.methods) {
                ...
                makeInstruction(I.PUSH, {operand: m.name});
                makeInstruction(I.MEMBER_ASSIGN);
                makeInstruction(I.POP);
            }
        }
