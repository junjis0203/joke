...
import { createScope, createObject } from './object.js';
...
function callFunction(context, func, args) {
    ...
    const {params, insns, scopes, thisValue, insnsList} = func;
...
function runInsns(context, insns) {
    ...
    while (ptr != insns.length) {
        ...
        if (context.debug) {
            // BUG: insn looks like [object Object]
            console.log(`ptr:${ptr}, insn:${insn}`);
        }
