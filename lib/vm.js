...
import { Scope, JokeObject, JokeFunction, JokeArray } from './object.js';
    ...
    case I.CALL:
        {
            ...
            let ret;
           if (target instanceof JokeFunction) {
    ...
    case I.SET_PROPERTY:
        {
            ...
            const value = stack.pop();
            const setter = object.getProperty('set ' + propertyName);
            if (setter) {
    ...
    case I.GET_PROPERTY:
        {
            ...
            const object = stack.pop();
            let property;
            const getter = object.getProperty('get ' + propertyName);
            if (getter) {
